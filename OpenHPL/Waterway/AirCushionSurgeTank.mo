...
model AirCushionSurgeTank "Model of the surge tank/shaft"
  ...
  input Modelica.SIunits.Pressure p_air = 3*Const.p_a "Initial pressure of air cushion" annotation (
    Dialog(group = "Geometry"));
  ...
  Modelica.SIunits.Pressure p_2 "pressure of air cushion";
...
equation
  ...
  p_2 = p_air*((L-h_0/cos_theta)/(L-l))^Const.gamma_air;
